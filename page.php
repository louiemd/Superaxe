	...
	<div class="content-wrapper <?php echo $sidebar_class; ?>">
		...
		<?php if(is_front_page()) { ?>
			<div class="page-wrapper">
				...
				<div class="four columns mt0">
					<?php if (!function_exists('dynamic_sidebar')|| !dynamic_sidebar('Home Custom Two')): ?><?php endif; ?>	
				</div>
				<div class="four columns mt0">
					<?php if (!function_exists('dynamic_sidebar')|| !dynamic_sidebar('Home Custom Three')): ?><?php endif; ?>	
				</div>
				<div class="four columns mt0">
					<?php if (!function_exists('dynamic_sidebar')|| !dynamic_sidebar('Home Custom Four')): ?><?php endif; ?>	
				</div>
				<br class="clear">
			</div>
